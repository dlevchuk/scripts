...
if(!$streets){
    ...
    //$uniqueArray = arrayUnique($streets); 
     ...
     if ($house_id >0) {
          ...
          $address_device=transliterate($stname);
              ...
              echo /*'Brigada - '.*/$key."\n";
              //echo '<br />';
              echo /*'Adress - '.*/$type_dgs."\n";  
              echo /*'Adress - '.*/$address_device.' '.$house."\n";  
              echo /*'Adress - '.*/$switch_ip."\n";  
          ...
          $address_device=transliterate($adress_dgs);
